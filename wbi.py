...
def get_user_cards(uids: str):
    req_url = 'https://api.vc.bilibili.com/account/v1/user/cards'
    req_params = dict()
...
def get_live_stream_danmu_info(room_id: int):
    req_url = 'https://api.live.bilibili.com/xlive/web-room/v1/index/getDanmuInfo'
    req_params = dict()
    req_params['id'] = room_id
    signed_params = get_wts_w_rid(req_params)
    response = requests.get(
        url=req_url,
        params=signed_params,
